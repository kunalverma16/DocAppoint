  ...
  <div class="container"> <!-- to add spacing on both sides -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="login.php">Login <i class="fas fa-user"></i></a></li>
	...
	font-size:4em;""><i class="fas fa-user"></i> Login!</h1>
	<br>
					<form method="POST" action="actions/backend_login.php">
						...
						<input type="password" name="password" class="form-control input" placeholder="Password" required autofocus><br>
						<button class="btn btn-lg btn-primary btn-block signup-btn" type="submit" name="login" id="login">Login</button>
						<!-- <input type="submit" name="login" value="Log in"> -->
						<br>
						<label>Not registered? Click <a href="registration.php">HERE</a> to register.</label>
					</form>
					<?php
						session_start();
