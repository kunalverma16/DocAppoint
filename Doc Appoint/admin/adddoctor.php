...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Add Doctors | Doc Appoint</title>
  <style>
    table, tr, th, td {
      margin-left:0%;
        text-align: center;
  ...
  <div class="container"> <!-- to add spacing on both sides -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="adddoctor.php"><span>Add Doctors</span></a></li>
...
<div style="text-align: center;" class="container">
  <div id="jumboabout"  class="page-header">
    <h1><i class="fas fa-stethoscope"></i> Add Doctors</h1>
  </div>
  <div >
    <div >
       ...
       <form method="POST" action="../actions/backend_adddoctors.php">
          ...
          <label>Available time (in 24hrs): </label><input type="time" name="time" required> <br><br>
          <!-- <input type="submit" name="add" value="Add"> -->
          <button class="btn btn-primary" type="submit" name="add" value="Add">Add Doctor</button>
        </form>
