...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Remove Doctors | Doc Appoint</title>
  <style>
    table, tr, th, td {
      margin-left:0%;
        text-align: center;
  ...
  <div class="container"> <!-- to add spacing on both sides -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="removedoctors.php"><span>Remove Doctors</span></a></li>
...
<div style="text-align: center;" class="container">
  <div id="jumboabout"  class="page-header">
    <h1><i class="fas fa-stethoscope"></i> Remove/Update Doctors</h1>
  </div>
  <div >
    <div >
