...
mysqli_query($conn,"CREATE DATABASE IF NOT EXISTS `quickdoc` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;");

mysqli_select_db($conn,"quickdoc");
...
(1, 'umang', 'sarkari', 'umang@gmail.com', 1234567890, '08:00:00');");
...
(1, 'Kunal Verma', 'kunalverma@gmail.com', 'Appointment', 'hi');");
...
(1, 'Surya Pratap', 'suryapratap@gmail.com', '123', 'bh3', '1996-04-13', 'Male');");
